package com.cat.hard.order.integration.account.service;
...
import com.cat.hard.order.integration.account.client.AccountServiceClient;
...
import com.cat.hard.order.integration.account.exception.AccountFailureType;
...
public class AccountQueryService {
	...
	@SentinelResource(
			...
			blockHandler = "handleGetUserSummaryBlocked")
	...
	@SentinelResource(
			...
			blockHandler = "handleGetAddressSnapshotBlocked")
	...
	public UserSummary handleGetUserSummaryBlocked(Long userId, BlockException exception) {
		throw blocked(exception);
	}

	public AddressSnapshot handleGetAddressSnapshotBlocked(
			Long userId,
			Long addressId,
