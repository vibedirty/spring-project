package com.cat.hard.order.integration.cart.config;

import java.util.UUID;

import com.cat.hard.order.common.logging.RequestLoggingFilter;
...
@Configuration
public class CartFeignConfiguration {
	...
	@Bean
	public Logger.Level cartFeignLoggerLevel() {
